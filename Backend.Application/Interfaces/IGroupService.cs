...
namespace Backend.Application.Interfaces
{
    ...
    {
        public Task<GroupInfoDTO?> GetGroupAsync(string username, int groupId);
        public Task<(int,List<GroupInfoDTO>)?> GetGroupsAsync(string username, int placeId, int pageId);
